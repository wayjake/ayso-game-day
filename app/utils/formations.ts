...
export const formations9v9: FormationSet = {
  '3-3-2': {
    ...
    positions: [
      { number: 1, x: 50, y: 92, abbreviation: 'GK' },
      { number: 2, x: 70, y: 75, abbreviation: 'RB' },
      { number: 3, x: 30, y: 75, abbreviation: 'LB' },
      { number: 4, x: 50, y: 75, abbreviation: 'CB' },
      { number: 6, x: 50, y: 65, abbreviation: 'CDM' },
      { number: 7, x: 75, y: 65, abbreviation: 'RM' },
      { number: 8, x: 25, y: 65, abbreviation: 'LM' },
      { number: 10, x: 40, y: 25, abbreviation: 'CAM' },
      { number: 9, x: 60, y: 25, abbreviation: 'CF' },
    ],
  },
  '3-2-3': {
    name: '3-2-3 Attack',
    positions: [
      { number: 1, x: 50, y: 92, abbreviation: 'GK' },
      { number: 2, x: 65, y: 75, abbreviation: 'RB' },
      { number: 3, x: 35, y: 75, abbreviation: 'LB' },
      { number: 4, x: 50, y: 75, abbreviation: 'CB' },
      { number: 6, x: 42, y: 55, abbreviation: 'CDM' },
      { number: 8, x: 58, y: 55, abbreviation: 'CDM' },
      { number: 7, x: 75, y: 30, abbreviation: 'RW' },
      { number: 11, x: 25, y: 30, abbreviation: 'LW' },
      { number: 9, x: 50, y: 30, abbreviation: 'CF' },
    ],
  },
  '2-4-2': {
    name: '2-4-2 Midfield',
  ...
  '4-2-2': {
    ...
    positions: [
      ...
      { number: 2, x: 75, y: 75, abbreviation: 'RB' },
      { number: 3, x: 25, y: 75, abbreviation: 'LB' },
      { number: 4, x: 44, y: 75, abbreviation: 'CB' },
      { number: 5, x: 56, y: 75, abbreviation: 'CB' },
  ...
  '3-1-3-1': {
    ...
    positions: [
      ...
      { number: 4, x: 50, y: 75, abbreviation: 'CB' },
      { number: 6, x: 50, y: 58, abbreviation: 'CDM' },
      { number: 7, x: 70, y: 45, abbreviation: 'RM' },
      { number: 8, x: 30, y: 45, abbreviation: 'LM' },
      { number: 10, x: 50, y: 40, abbreviation: 'CAM' },
